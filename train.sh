...
bash train_vit_others.sh dinov2_vitb_exp 5 dogs 196
bash train_vit_others.sh dinov2_vitb_exp 3 dogs 196
bash train_vit_others.sh dinov2_vits_exp 5 dogs 196
bash train_vit_others.sh dinov2_vits_exp 3 dogs 196
